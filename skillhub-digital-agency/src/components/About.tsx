    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="relative pt-12 pb-6">
          ...
          <div className="w-full h-[280px] md:h-[360px] lg:h-[420px] relative">
            <TimelineContent
              as="figure"
              animationNum={4}
              timelineRef={heroRef}
          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            >
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
                <span className="font-bold" style={{ color: "#FFFFFF", fontFamily: "var(--font-geist-sans)" }}>5+</span>
                <span style={{ color: "#FFFFFF", fontFamily: "var(--font-dm-sans)" }}>years building digital products</span>
                <span style={{ color: "var(--charcoal-line)" }}>|</span>
              </div>
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
                <span className="font-bold" style={{ color: "#FFFFFF", fontFamily: "var(--font-geist-sans)" }}>50+</span>
                <span style={{ color: "#FFFFFF", fontFamily: "var(--font-dm-sans)" }}>clients served</span>
              </div>
            </TimelineContent>
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              ...
              >
                <span className="font-semibold" style={{ color: "#FFFFFF", fontFamily: "var(--font-geist-sans)" }}>9</span>
                <span className="uppercase" style={{ color: "#FFFFFF", fontFamily: "var(--font-dm-sans)" }}>service areas</span>
              </TimelineContent>
              <TimelineContent
                as="div"
                animationNum={7}
              ...
              >
                <span className="font-bold" style={{ color: "#FFFFFF", fontFamily: "var(--font-geist-sans)" }}>Sandton</span>
                <span style={{ color: "#FFFFFF", fontFamily: "var(--font-dm-sans)" }}>headquartered</span>
            ...
            >
              ...
              >
                <p
                  ...
                  style={{ color: "#FFFFFF", fontFamily: "var(--font-dm-sans)", fontWeight: 300, lineHeight: 1.85 }}
                >
          ...
          <div className="md:col-span-1">
            <div className="text-right">
              <TimelineContent
                ...
                style={{ color: "#FFFFFF", fontFamily: "var(--font-geist-sans)" }}
              >
                SKILLHUB
              </TimelineContent>
              <TimelineContent
